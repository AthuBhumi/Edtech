    ...
    <div className="p-6">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-lg mb-6">Principal • Monday, February 23, 2026</p>

          <div className="grid grid-cols-4 gap-4">
            <div className="glass-card rounded-xl p-4">
              <Users className="w-6 h-6 text-[#2563EB] mb-2" />
              <p className="text-2xl font-bold text-white" style={{ fontFamily: 'var(--font-mono)' }}>1,247</p>
              <p className="text-xs text-white/60">Total Students</p>
            </div>

            <div className="glass-card rounded-xl p-4">
              <UserCheck className="w-6 h-6 text-[#10B981] mb-2" />
              <p className="text-2xl font-bold text-white" style={{ fontFamily: 'var(--font-mono)' }}>94%</p>
              <p className="text-xs text-white/60">Attendance Today</p>
            </div>

            <div className="glass-card rounded-xl p-4">
              <DollarSign className="w-6 h-6 text-[#F59E0B] mb-2" />
              <p className="text-2xl font-bold text-white" style={{ fontFamily: 'var(--font-mono)' }}>₹8.8L</p>
              <p className="text-xs text-white/60">Fee Collection (This Month)</p>
            </div>
      ...
      <div className="glass-card rounded-2xl p-6 mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-semibold text-white">ARIA Priority Alerts</h2>
        </div>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        ...
        <div className="glass-card rounded-2xl p-6">
          <h2 className="text-xl font-semibold text-white mb-4">Fee Collection Trend</h2>
        ...
        {/* Class Performance */}
        <div className="glass-card rounded-2xl p-6">
          <h2 className="text-xl font-semibold text-white mb-4">Class Performance</h2>
          <ResponsiveContainer width="100%" height={250}>
      ...
      {/* Recent Activities */}
      <div className="glass-card rounded-2xl p-6">
        <h2 className="text-xl font-semibold text-white mb-4">Recent School Activities</h2>
        <div className="space-y-3">
