  ...
  return (
    <div className="p-4 lg:p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-white/60 text-sm lg:text-base">Book inventory and borrowing analytics</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mb-6">
        ...
        <div className="lg:col-span-2 glass-card rounded-xl lg:rounded-2xl p-4 lg:p-6">
          <h2 className="text-lg lg:text-xl font-semibold text-white mb-4">Monthly Borrowing Trend</h2>
        ...
        <div className="glass-card rounded-xl lg:rounded-2xl p-4 lg:p-6">
          <h2 className="text-lg lg:text-xl font-semibold text-white mb-4">Category Usage</h2>
          <div className="space-y-4">
            {categoryUtilization.map((cat) => (
              <div key={cat.category}>
                <div className="flex justify-between mb-2">
                  <span className="text-sm text-white">{cat.category}</span>
                  <span className="text-sm text-white/60">{cat.utilization}%</span>
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
        {/* Popular Books */}
        <div className="glass-card rounded-xl lg:rounded-2xl p-4 lg:p-6">
          <h2 className="text-lg lg:text-xl font-semibold text-white mb-4">Most Popular Books 🔥</h2>
              ...
              <div key={idx} className="glass-card rounded-xl p-3 lg:p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-white truncate">{activity.book}</p>
