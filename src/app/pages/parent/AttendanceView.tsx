  ...
  return (
    <div className="p-4 lg:p-6">
      <div className="mb-6">
        ...
        <p className="text-white/60 text-sm lg:text-base">Monitor your children's attendance</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-6">
        <div className="glass-card rounded-xl lg:rounded-2xl p-4 lg:p-6">
          <h2 className="text-lg font-semibold text-white mb-4">Arjun (Class 8B)</h2>
          <div className="text-center mb-4">
            <p className="text-4xl font-bold text-white mb-2" style={{ fontFamily: 'var(--font-mono)' }}>
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="glass-card rounded-lg p-3">
              ...
              <p className="text-xl font-bold text-white">{arjunAttendance.present}</p>
              <p className="text-xs text-white/60">Present</p>
            </div>
            <div className="glass-card rounded-lg p-3">
              <XCircle className="w-5 h-5 text-[#F43F5E] mx-auto mb-1" />
              <p className="text-xl font-bold text-white">{arjunAttendance.absent}</p>
              <p className="text-xs text-white/60">Absent</p>
            </div>
            <div className="glass-card rounded-lg p-3">
              <Calendar className="w-5 h-5 text-[#2563EB] mx-auto mb-1" />
              <p className="text-xl font-bold text-white">{arjunAttendance.total}</p>
        ...
        <div className="glass-card rounded-xl lg:rounded-2xl p-4 lg:p-6">
          <h2 className="text-lg font-semibold text-white mb-4">Priya (Class 6A)</h2>
          <div className="text-center mb-4">
            <p className="text-4xl font-bold text-white mb-2" style={{ fontFamily: 'var(--font-mono)' }}>
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="glass-card rounded-lg p-3">
              <CheckCircle className="w-5 h-5 text-[#10B981] mx-auto mb-1" />
              <p className="text-xl font-bold text-white">{priyaAttendance.present}</p>
              <p className="text-xs text-white/60">Present</p>
            </div>
            <div className="glass-card rounded-lg p-3">
              <XCircle className="w-5 h-5 text-[#F43F5E] mx-auto mb-1" />
              <p className="text-xl font-bold text-white">{priyaAttendance.absent}</p>
              <p className="text-xs text-white/60">Absent</p>
            </div>
            <div className="glass-card rounded-lg p-3">
              <Calendar className="w-5 h-5 text-[#2563EB] mx-auto mb-1" />
              <p className="text-xl font-bold text-white">{priyaAttendance.total}</p>
              <p className="text-xs text-white/60">Total Days</p>
            </div>
          </div>
        </div>
          ...
          {recentActivity.map((item, idx) => (
            <div key={idx} className="glass-card rounded-xl p-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold text-sm">{item.child}</p>
                  <p className="text-xs text-white/60">Class {item.class}</p>
                </div>
              </div>
