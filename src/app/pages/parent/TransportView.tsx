  ...
  return (
    <div className="p-4 lg:p-6">
      <div className="mb-6">
        ...
        <p className="text-white/60 text-sm lg:text-base">Track your children's school buses</p>
      </div>
        ...
        {busDetails.map((bus, idx) => (
          <div key={idx} className="glass-card rounded-xl lg:rounded-2xl p-4 lg:p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-lg font-semibold text-white">{bus.child}</h2>
                <p className="text-sm text-white/60">Class {bus.class} • {bus.route}</p>
              </div>
              <Badge className={`${
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-4">
              <div className="glass-card rounded-lg p-3">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs text-white/60">Bus Number</span>
                </div>
                <p className="text-sm text-white font-semibold">{bus.bus}</p>
              </div>
              <div className="glass-card rounded-lg p-3">
                <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-sm text-white font-semibold">{bus.driver}</p>
              </div>
              <div className="glass-card rounded-lg p-3">
                <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-sm text-white font-semibold">{bus.eta}</p>
              </div>
              <div className="glass-card rounded-lg p-3">
                <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-sm text-white font-semibold">{bus.location}</p>
              </div>
            </div>
      ...
      <div className="glass-card rounded-xl lg:rounded-2xl p-4 lg:p-6 mt-6">
        ...
        <div className="aspect-video rounded-lg bg-gradient-to-br from-[#1B3A8C] to-[#0A1628] flex items-center justify-center">
