  ...
  return (
    <div className="p-4 lg:p-6">
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm lg:text-base">Access academic reports and certificates</p>
      </div>
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <div className="flex-1">
                    <h3 className="text-slate-800 font-semibold text-sm lg:text-base">{report.child} - {report.type}</h3>
                    <p className="text-xs text-slate-500">{report.term} • {report.date}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="text-right hidden lg:block">
                    <p className="text-sm font-semibold text-slate-800">{report.score}%</p>
                    <Badge className={`${
